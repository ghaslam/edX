...
#
# The 6.00 Word Game
# Originated by: Kevin Luu <luuk> and Jenna Wiens <jwiens>
# Modified by: Sarina Canelake <sarina>
# Completed by: Gareth Haslam <gareth>
#%%
...
#
#%%
#word = "problem" #raw_input("Enter word, or a ""."" to indicate that you are finished: ")
...
def updateHand(hand, word):
    ...
    #print hand        #print hand[letter]
    return hand
 
#hand = {'h': 1, 'e': 1, 'l': 2, 'o': 1}
#displayHand(hand)   
#hand = updateHand(hand, 'hello')
#displayHand(hand)   
#displayHand(updateHand(hand, 'hello'))
...
#wordList = ['aa', 'aah', 'honey','rapture','table','van']    
#isValidWord('honey', {'e': 2, 'd': 1, 'h': 1, 'o': 1, 'n': 1, 'w': 1, 'y': 1}, wordList)
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print word, " earned ", getWordScore(word, n), "points. Total:",\
                        score, "points."
                print        
                # Update the hand 
